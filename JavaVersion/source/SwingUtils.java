...
// Diese Klasse ist nicht von uns. Sie wird benötigt für den Win Dialog.
...
public class SwingUtils {
	...
	public static void addEscapeToCloseSupport(final JDialog dialog, final boolean fadeOnClose) {
		LayerUI<Container> layerUI = new LayerUI<Container>() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 5331022793927464368L;
	...
	private static class DialogBackPanel extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7678980437769511577L;
		...
		private final JLabel info = new JLabel("Hit 'ESC' to continue playing");
